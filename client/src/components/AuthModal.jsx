              ...
              <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-4">
                ...
                <div className="flex items-center justify-between mt-6">
                  <label className="flex items-center">
                    ...
                    />
                    <span className="mr-2 text-sm text-gray-600 arabic-text">تذكرني</span>
                  </label>
            ...
            {isSignupMode && (
              <form onSubmit={signupForm.handleSubmit(handleSignup)} className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full mt-6"
                >
                  {isSignupLoading ? 'جاري إنشاء الحساب...' : 'إنشاء حساب جديد'}
                </Button>
              </form>
            )}
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button 
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors duration-200 flex items-center justify-center"
                >
